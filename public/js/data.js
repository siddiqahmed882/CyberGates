export const services = [{
    ...
    },
    {
        ...
        desc: "Distributed Denial of Service (DDoS) attacks are ever-evolving and use a variety of technologies. To  successfully combat these attacks, you need a dynamic, multi-layered security solution. CYBER GATES DDoS solution protects from both known and zero day attacks with very low latency. It’s easy to deploy and manage, and includes comprehensive reporting and analysis tools.",
        iconClasses: ["fas", "fa-globe"],
    },
    {
        title: "Virtual Private Network",
        desc: "CYBER GATES VPN service, secures your internet connection with military grade AES256 encryption to guarantee that all of the data you're sending and receiving is strongly encrypted and secured from prying eyes. We have employed world’s leading encryption standard AES‑256 to secure your personal and financial information so that it stays out of the hands of identity and data thieves.",
